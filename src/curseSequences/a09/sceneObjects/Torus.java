...
import static curseSequences.a09.maths.EquationSolver.*;

// Quelle für Algorithmus / Berechnung: 
...
public class Torus implements Shape {
	...
	public Hit intersect(Ray ray) {
        ...
        {
        	if (tArray[i] > ray.T_MIN) {
        		Vec3 hitPoint = add(ray.x0, multiply(tArray[i],ray.d));
        		return new Hit(tArray[i], hitPoint, surfaceNormal(hitPoint), material);
        	}
        }
        return null;
	}
