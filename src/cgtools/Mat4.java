...
public final class Mat4 {
     ...
     */
    public Vec3 transformPoint(Vec3 v) { // ruft man auf der Matrix auf, wenn sie erstellt wurde und ggf. mit anderen Matrizen verkettet wurde
        final double x = get(0, 0) * v.x + get(1, 0) * v.y + get(2, 0) * v.z + get(3, 0); //*1 von w
